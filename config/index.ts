export default {
  ...
  metadata: {
    ...
    generator: 'Next.js',
    applicationName: 'DScroll Documentation',
    appleWebApp: {
      title: 'DScroll Documentation',
    },
    openGraph: {
      // https://github.com/vercel/next.js/discussions/50189#discussioncomment-10826632
      url: './',
      siteName: 'DScroll Documentation',
      locale: 'en_US',
      type: 'website',
    },
    other: {
   ...
   */
  nextraLayout: {
    docsRepositoryBase: 'https://github.com/dscroll/dscroll-docs/tree/main/',
    sidebar: {
   ...
   */
  gitHub: {
    repo: 'dscroll/dscroll-docs',
    apiUrl: 'https://api.github.com',
    releasesUrl: 'https://api.github.com/repos/dscroll/dscroll-docs/releases',
  },
   ...
   */
  releaseNotes: {
    url: 'https://github.com/dscroll/dscroll-docs/releases',
    maxReleases: 10,
  },
